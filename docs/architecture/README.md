...
| 5   | The elevation code sits outside the platform layer | Speculative     | Resolved | [05-privilege-layering.md](05-privilege-layering.md)             |
...
Nothing — all five issues are resolved. New platform code goes under `scm/`.
